...
class _VideoCallScreenState extends State<VideoCallScreen> {
  ...
  void _setupSignaling() {
    _signaling = SignalingService(
      userId:
          'patient_${widget.appointment.id}', // You should use actual patient ID
      callId: widget.callId,
      serverUrl: 'ws://localhost:8080', // Local development server
    );
    ...
    _signaling
        ...
        .then((_) {
          setState(() {
            _isInitiator = true; // The patient initiates the call
          });
          _createOffer();
        })
        .catchError((e) {
